...
function RouteComponent() {
    ...
    const [userType, setUserType] = useState<"faculty" | "admin" | "student">("faculty");
    ...
    const getPasswordLabel = () => {
        switch (userType) {
            ...
            case "faculty": return "Faculty Password";
            case "student": return "Student Password";
    ...
    return (
        <div className="box-border bg-gradient-to-br from-blue-50 to-white min-h-screen">
            <h2 className="text-6xl text-center mt-24 text-black-800 font-bold">
